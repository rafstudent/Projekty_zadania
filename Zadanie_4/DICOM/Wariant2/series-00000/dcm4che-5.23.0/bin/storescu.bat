...
set MAIN_JAR=dcm4che-tool-storescu-5.23.0.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-5.23.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-5.23.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-opencv-5.23.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-5.23.0.jar
